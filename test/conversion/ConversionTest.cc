...
TEST(ConversionTest, GetBitBoardIndexTest)
{
  // 各配列Indexの境界値テスト
  // 横方向
...
TEST(ConversionTest, GetBitBoardShiftTest)
{
  // シフト量の全数テスト
...
TEST(ConversionTest, GetBitBoardIndexListTest)
{
  {
    // 左上の境界
...
TEST(ConversionTest, GetBitBoardShiftListTest){
  {
    // 左上の境界
    constexpr Cordinate x = 1, y = 1;
...
TEST(ConversionTest, GetBoardPositionTest)
{
...
TEST(ConversionTest, GetBoardDirectionTest)
{
  // 境界値テスト
...
TEST(ConversionTest, GetBoardMoveTest)
{
...
TEST(ConversionTest, GetBoardCordinateTest)
{
  Cordinate x = 0, y = 0;
